Public Class Simple_If
    ...
    Private Sub btnAnotherIf_Click(sender As Object, e As EventArgs) Handles btnAnotherIf.Click
        ...
        If intNumber = 1000 Then
            MessageBox.Show("'intNumber' is, indeed, 1000!", "Simple
If")
        End If
    End Sub

    Private Sub btnAnotherIf1_Click(sender As Object, e As EventArgs) Handles btnAnotherIf1.Click
        'Declare and set a variable
        Dim intNumber As Integer = 27
        'Here's where you make a decision,
        'and tell the user what happened
    ...
    Private Sub btnAnotherIf2_Click(sender As Object, e As EventArgs) Handles btnAnotherIf2.Click
        'Declare and set a variable
        Dim intNumber As Integer = 27
        'Here's where you make a decision,
        'and tell the user what happened
        ...
        Else
            MessageBox.Show("'intNumber' is neither 1000 nor 27!", "Simple
If")
        End If
    End Sub
End Class